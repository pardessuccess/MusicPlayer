...
//import com.pardess.musicplayer.data.service.MusicService.Companion.ACTION_FAVORITE
...
//    }
//
//    private fun getFavoriteAction(context: Context): NotificationCompat.Action {
//        val actionIntent =
//            Intent(context, MusicService::class.java).apply { action = ACTION_FAVORITE }
//        val pendingIntent = PendingIntent.getService(context, 0, actionIntent, FLAG_IMMUTABLE)
...
//        val favoriteAction = getFavoriteAction(context)
